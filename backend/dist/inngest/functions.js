...
exports.therapySessionHandler = _1.default.createFunction({ id: "therapy-session-handler" }, { event: "therapy/session.created" }, async ({ event, step }) => {
...
exports.moodTrackingHandler = _1.default.createFunction({ id: "mood-tracking-handler" }, { event: "mood/updated" }, async ({ event, step }) => {
    // Log the mood update
...
exports.activityCompletionHandler = _1.default.createFunction({ id: "activity-completion-handler" }, { event: "activity/completed" }, async ({ event, step }) => {
