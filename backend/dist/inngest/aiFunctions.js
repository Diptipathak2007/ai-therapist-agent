...
const _1 = __importDefault(require(".")); // Adjusted path to point to the correct location
const generative_ai_1 = require("@google/generative-ai");
const logger_1 = require("../utils/logger");
// Initialize Gemini
const genAI = new generative_ai_1.GoogleGenerativeAI(process.env.GEMINI_API_KEY || "");
// Function to handle chat message processing
exports.processChatMessage = _1.default.createFunction({
...
exports.analyzeTherapySession = _1.default.createFunction({ id: "analyze-therapy-session" }, { event: "therapy/session.created" }, async ({ event, step }) => {
    try {
...
exports.generateActivityRecommendations = _1.default.createFunction({ id: "generate-activity-recommendations" }, { event: "mood/updated" }, async ({ event, step }) => {
    try {
