...
exports.getSessionHistory = exports.sendMessage = exports.getChatHistory = exports.getChatSession = exports.getAllChatSessions = exports.createChatSession = void 0;
...
const getAllChatSessions = async (req, res) => {
    try {
        ...
        logger_1.logger.error("Get all sessions error:", error);
...
const sendMessage = async (req, res) => {
    try {
        ...
        try {
          ...
          6. Be supportive but not replace professional therapy`,
            ...
            if (inngest_1.default) {
                await inngest_1.default.send(event);
            }
        }
        catch (inngestError) {
            logger_1.logger.warn("Inngest event failed, continuing with AI processing:", inngestError);
        }
    ...
    Required JSON structure:
    {
      ...
      "progressIndicators": ["string array of positive/negative indicators"]
        ...
        try {
            ...
            logger_1.logger.warn("Analysis failed, using default:", analysisError);
            analysis = {
    ...
    Provide a thoughtful, professional therapeutic response that helps the user process their thoughts and feelings while maintaining appropriate boundaries.`;
        ...
        try {
            ...
            logger_1.logger.info("Generated AI response successfully");
        }
        catch (aiError) {
